...
class TestTPT():
    ...
    def test_committors(self):
        ...
        Q_ref = Serializer.load_data(os.path.join(self.tpt_ref_dir, "committors.h5"))
    ...
    def test_flux(self):
        ...
        flux_ref = Serializer.load_data(os.path.join(self.tpt_ref_dir,"flux.h5"))
        npt.assert_array_almost_equal(flux.toarray(), flux_ref)
        
        net_flux = tpt.calculate_net_fluxes(self.sources, self.sinks, self.tprob)
        net_flux_ref = Serializer.load_data(os.path.join(self.tpt_ref_dir,"net_flux.h5"))
    ...
    def test_path_calculations(self):
        ...
        paths_ref = Serializer.load_data(os.path.join(self.tpt_ref_dir,"dijkstra_paths.h5"))
        fluxes_ref = Serializer.load_data(os.path.join(self.tpt_ref_dir,"dijkstra_fluxes.h5"))
        bottlenecks_ref = Serializer.load_data(os.path.join(self.tpt_ref_dir,"dijkstra_bottlenecks.h5"))
    ...
    def test_mfpt(self):
        ...
        mfpt_ref = Serializer.load_data(os.path.join(self.tpt_ref_dir, "mfpt.h5"))
        ...
        ensemble_mfpt_ref = Serializer.load_data(os.path.join(self.tpt_ref_dir, "ensemble_mfpt.h5"))
        npt.assert_array_almost_equal(ensemble_mfpt, ensemble_mfpt_ref)
        
        all_to_all_mfpt = tpt.calculate_all_to_all_mfpt(self.tprob)
        all_to_all_mfpt_ref = Serializer.load_data(os.path.join(self.tpt_ref_dir, "all_to_all_mfpt.h5"))
