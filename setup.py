...
XTC = Extension('Emsmbuilder/libxdrfile',
                  sources = [
...
LPRMSD = Extension('Emsmbuilder/_lprmsd',
...
DISTANCE = Extension('Emsmbuilder/_distance_wrap',
                      ...
                      extra_link_args=['-lgomp'],
                      include_dirs = [numpy.get_include(), os.path.join(numpy.get_include(), 'numpy')])
DIHEDRAL = Extension('Emsmbuilder/_dihedral_wrap',
                     ...
                     extra_link_args=['-lgomp'],
                     include_dirs = [numpy.get_include(), os.path.join(numpy.get_include(), 'numpy')])
CONTACT = Extension('Emsmbuilder/_contact_wrap',
                    ...
                    extra_link_args=['-lgomp'],
                    include_dirs = [numpy.get_include(), os.path.join(numpy.get_include(), 'numpy')])
RG = Extension('Emsmbuilder/_rg_wrap',
...
def buildKeywordDictionary():
    ...
    setupKeywords = {}
    setupKeywords["name"]              = "Emsmbuilder"
    ...
    setupKeywords["packages"]          = ["Emsmbuilder",
                                          "Emsmbuilder.scripts",
                                          "Emsmbuilder.geometry"]
    setupKeywords["package_dir"]       = {"Emsmbuilder": "src/python",
                                          "Emsmbuilder.scripts": "scripts/"}
