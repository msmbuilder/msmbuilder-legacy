"""
lh5reporter.py: Output a trajectory in MSMBuilder H5 format.

This class is for use with the Python OpenMM App.  This class allows OpenMM to directly write an MSMBuilder2 H5 Trajectory.
...
simulation.reporters.append(H5Reporter.H5Reporter("Trajectories/trj0.lh5", 2000,R1))
"""
...
class H5Reporter(object):
    """H5Reporter outputs a series of frames from a Simulation to a PDB file.
    
    To use it, create a H5Reporter, than add it to the Simulation's list of reporters.
    """
    ...
    def PrepareH5File(self,filename):
        ...
        self.TrajObject.SaveToHDF(filename)
