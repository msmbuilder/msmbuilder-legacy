...
os.system("ConvertDataToHDF.py -s %s/native.pdb -I %s/XTC/"%(TutorialDir,TutorialDir))
os.system("CreateAtomIndices.py -s %s/native.pdb"%TutorialDir)
...
os.system("CalculateRMSD.py -s %s/native.pdb -I Data/Gens.lh5"%TutorialDir)
os.system("CalculateClusterRadii.py -a Data/Assignments.h5")
os.system("CalculateProjectRMSD.py -s %s/native.pdb"%TutorialDir)
