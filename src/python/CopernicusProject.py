...
# This file us currently deprecated, and its future status is unkown.
# Currently, nobody on the MSMBuilder development team is using 
# Copernicus, so these hooks are without a maintainer.
#
# If you are interested in using these copernicus hooks with msmbuilder,
# please open an issue on the MSMBuilder github. https://github.com/SimTk/msmbuilder
