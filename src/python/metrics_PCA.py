...
import abc
import re
from Emsmbuilder import _rmsdcalc # this is a forked version of the msmbuilder rmsdcalc
...
class RMSD(AbstractDistanceMetric):
    ...
    class TheoData(object):
        ...
        def CheckCentered(self, Epsilon=1E-5):
            ...
            if x>Epsilon:
                raise Exception("The coordinate data does not appear to have been centered correctly. x=%f" % x)
...
class ProtLigRMSD(AbstractDistanceMetric):
    ...
    def __init__(self, protein_indices, ligand_indices, pdb):
        ...
        pdb should be an Emsmbuilder.Conformation object which contains the XYZ
