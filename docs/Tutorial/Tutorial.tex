...
\end{itemize}
Note that the Enthought Python Distribution contains most of these prerequisites and provides an easy way to facilitate installation.  Note the EPD free does \emph{not} contain all the required prerequisites, but the full or academic versions do.  
