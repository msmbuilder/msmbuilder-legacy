...
The following command clusters your data using the RMSD metric and a hybrid k-centers k-medoids clustering algorithm.  The clustering continues until the intercluster distance is 0.35 \AA.
...
\caption{Randomly selected conformations from the four macrostate model}
\end{center}
\end{figure}
