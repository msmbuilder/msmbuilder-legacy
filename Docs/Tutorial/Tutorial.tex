...
The following command clusters your data using the RMSD metric and a hybrid k-centers k-medoids clustering algorithm.  Note that other clustering protocols might lead to improved models; see the AdvancedMethods tutorial for details.

\begin{verbatim}
Cluster.py rmsd hybrid
\end{verbatim}
